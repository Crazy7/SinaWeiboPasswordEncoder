...
(function () {
    ...
    var d = function (l) {
        return l < 20
            ? 1518500249
            : l < 40 ? 1859775393 : l < 60 ? -1894007588 : -899497514;
    };
    var f = function (l, o) {
            ...
            switch (m) {
                case "v01":
                    ...
                    return decodeURIComponent(
                        j(sinaSSOEncoder.base64.decode(n, "binnary", "array"))
                    );
                    break;
                case "v02":
                    l = l.replace(/\./g, "=");
...
(function () {
    ...
    if (Y && "Netscape" == "Microsoft Internet Explorer") {
        aq.prototype.am = ax;
        av = 30;
    } else {
        if (Y && "Netscape" != "Netscape") {
            aq.prototype.am = b;
            av = 26;
        } else {
            aq.prototype.am = aw;
    ...
    function E(aH, aE, aD) {
        ...
        while (--aK >= 0) {
            var aA =
                aD[--aL] == az
                    ? this.DM
                    : Math.floor(aD[aL] * aQ + (aD[aL - 1] + aO) * aP);
    ...
    function P(t) {
        ...
        for (var az = 0; az < this.m.t; ++az) {
            ...
            var aA =
                (z * this.mpl +
                    (((z * this.mph + (t[az] >> 15) * this.mpl) & this.um) << 15)) &
                t.DM;
            z = az + this.m.t;
...
function encodePwd(pwd, servicetime, nonce, rsaPubkey) {
    var RSAKey = new sinaSSOEncoder.RSAKey();
    RSAKey.setPublic(rsaPubkey, "10001");
    var pwd = servicetime + '\t' + nonce + '\n' + pwd;
